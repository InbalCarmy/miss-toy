...
function getById(id) {
  return storageService.get(STORAGE_KEY, id).then((toy) => {
  ...
  if (!toys || !toys.length) {
    toys = [
      ...
      },
      {
        ...
        name: 'Remote Car',
        price: 180,
        labels: ['Car', 'Remote Control', 'Battery Powered'],
        createdAt: Date.now(),
        inStock: false,
      },
      {
      ...
      },
      {
        ...
        price: 75,
        labels: ['Puzzle', 'Board Game', 'Logic'],
        createdAt: Date.now(),
        inStock: true,
      },
      {
        ...
        name: 'Drone X200',
        price: 550,
        labels: ['Drone', 'Flying', 'Battery Powered'],
        createdAt: Date.now(),
        inStock: false,
      },
      {
      ...
      },
      {
        ...
        name: 'Train Set',
        price: 200,
        labels: ['Train', 'Tracks', 'Battery Powered'],
        createdAt: Date.now(),
        inStock: true,
      },
      {
      ...
      },
      {
        ...
        name: 'Rubik’s Cube',
        price: 30,
        labels: ['Logic', 'Puzzle', 'Brain Teaser'],
        createdAt: Date.now(),
        inStock: true,
      },
      {
      ...
      },
      {
        ...
        name: 'Chess Set',
        price: 95,
        labels: ['Board Game', 'Logic', 'Classic'],
        createdAt: Date.now(),
        inStock: true,
      },
      {
        ...
        price: 80,
        labels: ['Action Figure', 'Superhero', 'Collectible'],
        createdAt: Date.now(),
        inStock: false,
      },
      {
      ...
      },
      {
        ...
        name: 'RC Helicopter',
        price: 320,
        labels: ['Flying', 'Remote Control', 'Battery Powered'],
        createdAt: Date.now(),
        inStock: false,
      },
      {
        ...
        price: 110,
        labels: ['Board Game', 'Family', 'Classic'],
        createdAt: Date.now(),
        inStock: true,
      },
    ]
